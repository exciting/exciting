	...
	<xsl:template match="/">
	 ...
	 <xsl:element name="META">
        ...
        <table><tr><td valign = "top">
          ...
          <xsl:attribute name="href">
        <xsl:call-template name="agraph">
        <xsl:with-param name="data" select="/info/groundstate/structure/species[@chemicalSymbol=$chemicalSymbol]/atom[position()=$anr]/forces/@Magnitude" />
        ...
        <xsl:value-of select="@chemicalSymbol"/><xsl:text>+atom+</xsl:text>
         <xsl:value-of select="$anr"/><xsl:text>+Force+Magnitude</xsl:text>
          ...
          <td><xsl:value-of select="forces/@Magnitude"/></td>
					...
					<xsl:attribute name="href">
				 <xsl:call-template name="agraph">
				<xsl:with-param name="data" select="/info/groundstate/structure/species[@chemicalSymbol=$chemicalSymbol]/atom[position()=$anr]/forces/*[name()=$forcename]/@*[name()=$attname]" />
				<xsl:with-param name="title" ><xsl:text>species+</xsl:text>
				<xsl:value-of select="$chemicalSymbol"/><xsl:text>+atom+</xsl:text>
