...
def test_case_species_files(tests: List[str], sub_directory: str) -> dict:
    """
    ...
    species_per_test = {}
    for test in tests:
        directory = os.path.join(test, sub_directory)
        try:
...
def input_files_for_tests(tests: List[str], sub_directory='') -> dict:
    """
    ...
    """
    species_files_per_test = test_case_species_files(tests, sub_directory)
