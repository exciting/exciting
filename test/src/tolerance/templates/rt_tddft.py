...
Tolerances in default_tolerances cover files
  * CURRENT.OUT
  * N_EXCITATIONS.OUT
  * TOTENERGY_RTTDDFT.OUT
  * EIGVAL_*.OUT
  * OCCSV_TXT_*.OUT
  * PROJECTION_COEFFS_*.OUT
  * ATOM_????.OUT
  * FCR_????.OUT
  * FEXT_????.OUT
  * FHF_????.OUT
...
rt_tddft_tolerances = {'CURRENT.OUT': rt_tddft_jind,
                       'N_EXCITATIONS.OUT': rt_tddft_nexc,
                       'TOTENERGY_RTTDDFT.OUT': rt_tddft_etot,
                       'EIGVAL_??.OUT': rt_tddft_eigval,
                       'OCCSV_TXT_??.OUT': rt_tddft_occupations,
                       'PROJECTION_COEFFS_??.OUT': rt_tddft_proj,
