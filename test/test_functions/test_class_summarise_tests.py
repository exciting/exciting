...
def test_timings(successful_test_dir):
    ...
    slow_test = ExTestResults(name='Slow test', completed=True, out_mess="", err_msg="", timing=600.0)
    avg_test = ExTestResults(name='Average-speed test', completed=True, out_mess="", err_msg="", timing=10.0)
    fast_test = ExTestResults(name='Fast test', completed=True, out_mess="", err_msg="", timing=0.99)
