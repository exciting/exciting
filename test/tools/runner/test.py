...
def run_single_test(test_farm:str, main_out:str, test_name:str, run_dir:str,
                  ref_dir:str, input_file:str, species_files:List[str], init_default:str, executable:str, max_time:str, 
    ...
    :param test_name:       test case that will be run
    ...
    test_dir = os.path.join(test_farm, test_name)
    ...
    run_success, errMess, timing[init['name']] = execute(os.path.join(test_dir, run_dir), 
                                                         executable, 
                                                         main_out, 
                                                         max_time)
    if not run_success:
        report.runFailed(test_name, errMess)
...
def run_tests(test_farm:str, main_out:str, test_list:List[str], run_dir:str, ref_dir:str,
             input_file:str, species_files:List[str], init_default:str, executable:str, np:int, omp:int, max_time:int,
