...
class TestCompare(unittest.TestCase):
    ...
    def test_compare_data_NoFails(self):
        ...
        test.evaluate(data, reference)
        self.assertEqual(test.countFailures(),
                         dict({'total': 0, 'format': 0, 'float': 0, 'array': 0, 'string': 0, 'reference': 0}))
    ...
    def test_compare_data_FormatFails(self):
        ...
        test.evaluate(data, reference)
        self.assertEqual(test.countFailures(),
                         dict({'total': 1, 'format': 1, 'float': 0, 'array': 0, 'string': 0, 'reference': 0}))
    ...
    def test_compare_data_ListFails(self):
        ...
        test.evaluate(data, reference)
        self.assertEqual(test.countFailures(),
                         dict({'total': 1, 'format': 0, 'float': 0, 'array': 1, 'string': 0, 'reference': 0}))
    ...
    def test_compare_data_FloatFails(self):
        ...
        test.evaluate(data, reference)
        self.assertEqual(test.countFailures(),
                         dict({'total': 1, 'format': 0, 'float': 1, 'array': 0, 'string': 0, 'reference': 0}))
    ...
    def test_compare_data_StringFails(self):
        ...
        test.evaluate(data, reference)
        self.assertEqual(test.countFailures(),
                         dict({'total': 1, 'format': 0, 'float': 0, 'array': 0, 'string': 1, 'reference': 0}))
