...
```
cd test
pytest -s tools/selftests/test_class_errorfinder.py
```
"""
...
from tools.tester.compare import hashable_list, ErrorFinder
...
class TestErrorFinderReferenceWithTarget(unittest.TestCase):
    ...
    def test_test_and_ref_data_equal(self):
        ...
        self.assertEqual(result.keys_not_in_tol, [], "Expected all tolerances to be checked")
