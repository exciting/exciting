...
print "################################################\n"
LDA_dir=raw_input("name of LDA directory: ")
EXX_dir=raw_input("name of EXX directory: ")
print "\n"
...
i=bandlen-1
ax1.plot(ksene[i][0],ksene[i][1],'b',lw=3.0,label='LDA')
ax1.plot(gwene[i][0],gwene[i][1],'r',lw=3.0,label='EXX')
