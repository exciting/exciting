...
def test_dielectric(epsilon_results: dict, reference: str):
    ...
    assert np.allclose(epsilon_results['real_oscillator_strength'], epsilon_reference['real_oscillator_strength']), \
        f"Real part of dielectric function not equivalent to reference calculation"

    assert np.allclose(epsilon_results['imag_oscillator_strength'], epsilon_reference['imag_oscillator_strength']), \
        f"Imaginary part of dielectric function not equivalent to reference calculation"
                        
    assert np.allclose(epsilon_results['real_oscillator_strength_kkt'], epsilon_reference['real_oscillator_strength_kkt']),\
        f"Real part of dielectric function (by Kramers-Kronig) not equivalent to reference calculation"

    
def test_loss(loss_results: dict, reference: str):
