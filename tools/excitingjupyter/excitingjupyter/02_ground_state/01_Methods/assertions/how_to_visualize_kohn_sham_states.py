...
TUTORIAL_RUNDIR = "../run_KS_silicon/test_GS"
...
def test_groundstate(converged_results: dict):
    ...
    core_leakage_charge = 0.00762088
    ...
    interstitial_region_charge = 4.42479583
    ...
    muffin_tins_charge = 23.57520417
