...
REFERENCE_DIR = "reference_04_tutorial_xray_emission_spectra"
...
def test_dielectric(file_name: str):
...
def main():
    ...
    test_dielectric("EPSILON_BSE-IP_SCR-full_OC11.OUT")

    test_loss("LOSS_BSE-IP_SCR-full_OC11.OUT")
