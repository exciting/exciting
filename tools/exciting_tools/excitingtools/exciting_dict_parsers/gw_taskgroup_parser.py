...
def __parse_file_with_matrix(file_name:str) -> dict:
    """
    ...
    with open(file_name, 'r') as file:
        ...
        assert dim==2 and m_ini==1 and n_ini==1
...
def __parse_file_with_array_of_rank_3(file_name:str) -> dict:
    """
    ...
    with open(file_name, 'r') as file:
        ...
        assert dim==3 and m_ini==1 and n_ini==1 and p_ini==1
...
def __square_matrix(A:np.matrix):
    return np.matmul(A.T.conj(), A)

def parse_barc(file_name:str) -> dict:
    """
    ...
    """
    return {"CoulombMatrix": __square_matrix(__parse_file_with_matrix(file_name)["matrix"])}

def parse_sgi(file_name:str) -> dict:
    """
    ...
    """
    return {"OverlapMatrix": __square_matrix(__parse_file_with_matrix(file_name)["matrix"])}
