...
from mock_gw_info_out import zro2_gw_info_out, si_2_gw_info_out
...
def test_parse_correlation_self_energy_params():
    ...
    output = parse_correlation_self_energy_params(zro2_gw_info_out)
...
def test_parse_mixed_product_params():
    ...
    output = parse_mixed_product_params(zro2_gw_info_out)
...
def test_parse_bare_coulomb_potential_params():
    ...
    output = parse_bare_coulomb_potential_params(zro2_gw_info_out)
...
def test_parse_frequency_grid():
    ...
    """
    n_points = 32
    f_grid = parse_frequency_grid(zro2_gw_info_out, n_points)
...
def test_extract_kpoint():
    ...
    output = extract_kpoints(zro2_gw_info_out)
...
def test_parse_band_structure_info():
    ...
    ks_output = parse_band_structure_info(zro2_gw_info_out, 'ks')
    assert ks_output == ks_ref, "Expect parsed KS band structure info to match the reference"


def test_parse_g0w0_band_structure_info():
    ...
    gw_output = parse_band_structure_info(si_2_gw_info_out, 'gw')
    ...
    gw_output = parse_band_structure_info(zro2_gw_info_out, 'gw')
    assert gw_output == g0w0_ref, \
...
def test_parse_gw_info():
    ...
    output = parse_gw_info(zro2_gw_info_out)
...
def test_parse_gw_timings():
    ...
    assert parse_gw_timings(zro2_gw_info_out) == ref, "Parsed timings do not agree with reference dictionary"
