...
reference_fastBSE_absorption_spectrum = {
    ...
    'broadening': 0.1360569193000000E+00,
    'frequency': np.array(
        [+0.0000000000000000E+00, +0.6046974191111111E+01, +0.1209394838222222E+02]),
    'imag_epsilon': np.array(
        [[+0.0000000000000000E+00, +0.0000000000000000E+00, +0.0000000000000000E+00],
         [+0.2462935121365850E+00, +0.2462935121365850E+00, +0.2462935121365850E+00],
         [+0.2028366299352899E+02, +0.2028366299352899E+02, +0.2028366299352899E+02]]
         )
    }


def test_parse_fastBSE_absorption_spectrum_out_parser(fastBSE_absorption_spectrum_out_mock):
    fastBSE_absorption_spectrum_out = parse_fastBSE_absorption_spectrum_out(
        fastBSE_absorption_spectrum_out_mock.file
        )
    assert np.allclose(
        fastBSE_absorption_spectrum_out['energy_unit'], 
        reference_fastBSE_absorption_spectrum['energy_unit']
        )
    assert np.allclose(
        fastBSE_absorption_spectrum_out['broadening'], 
        reference_fastBSE_absorption_spectrum['broadening']
        )
    assert np.allclose(
        fastBSE_absorption_spectrum_out['frequency'], 
        reference_fastBSE_absorption_spectrum['frequency']
        )
    assert np.allclose(
        fastBSE_absorption_spectrum_out['imag_epsilon'], 
        reference_fastBSE_absorption_spectrum['imag_epsilon']
        )
...
reference_fastBSE_exciton_energies = {
    'energy_unit': 0.3674932539796232E-01,
    'ip_band_gap': 0.8205751967708917E+01,
...
def test_parse_fastBSE_exciton_energies_out_parser(fastBSE_exciton_energies_out_mock):
    fastBSE_exciton_energies_out = parse_fastBSE_exciton_energies_out(
        fastBSE_exciton_energies_out_mock.file
        )
    assert np.allclose(
        fastBSE_exciton_energies_out['energy_unit'], 
        reference_fastBSE_exciton_energies['energy_unit']
        )
    assert np.allclose(
      fastBSE_exciton_energies_out['ip_band_gap'], 
      reference_fastBSE_exciton_energies['ip_band_gap']
      )
    assert np.allclose(
      fastBSE_exciton_energies_out['exciton_energies'], 
      reference_fastBSE_exciton_energies['exciton_energies']
      )
