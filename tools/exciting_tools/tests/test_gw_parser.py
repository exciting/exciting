...
def test_k_points_from_evalqp():
    ...
    ref = {1: {'k_point': [0.000000, 0.000000, 0.000000], 'weight': 0.125000},
...
def test_parse_vxcnn():
    ...
    v_xc_1 = np.array([[-2.908349, -0.000000],
                       [-2.864103,  0.000000],
                       [-2.864103, -0.000000],
                       [-2.864103, -0.000000],
                       [-2.764246, -0.000000],
    ...
    v_xc_2 = np.array([[-2.908349,  0.000000],
                       [-2.864100, -0.000000],
                       [-2.864100,  0.000000],
                       [-2.864101, -0.000000],
                       [-2.764227, -0.000000],
    ...
    v_xc_3 = np.array([[-2.908349, -0.000000],
                       [-2.864099, -0.000000],
                       [-2.864099, -0.000000],
                       [-2.864099,  0.000000],
                       [-2.764195,  0.000000],
...
def test_parse_eps00_gw():
    ...
    ref = {1: {'frequency': 0.00529953,
               'eps00':
                       {'re': np.array([[8.31881773, 0.        , 0.        ],
                                        [0.        , 8.31881773, 0.        ],
                                        [0.        , 0.        , 8.31881773]]),
                        'img': np.array([[0., 0., 0.],
                                         [0., 0., 0.],
           ...
           2: {'frequency': 0.02771249,
               'eps00':
                   {'re': np.array([[8.22189228, 0.        , 0.        ],
                                    [0.        , 8.22189228, 0.        ],
                                    [0.        , 0.        , 8.22189228]]),
                    'img': np.array([[-0.,  0.,  0.],
                                     [ 0., -0.,  0.],
