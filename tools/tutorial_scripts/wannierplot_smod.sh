...
array set DG {envar0,0 1.0 subident,2,0 BEGIN_DATAGRID_3D ident,0 {squared modulus} type,2 3D n_subblock,2 1 envar1,0 1.0 cb0,0 1 ident,1 real envar2,0 1.0 cb1,0 0 r0 .dg.1.c.f0.r0 ident,2 imaginary cb2,0 0 r1 .dg.1.c.f1.r1 r2 .dg.1.c.f2.r2 yspace 5 YSpace 15 c0,0 .dg.1.c.sf0_0.r c1,0 .dg.1.c.sf1_0.r l0,0 .dg.1.c.sf0_0.l2 n_block 3 c2,0 .dg.1.c.sf2_0.r l1,0 .dg.1.c.sf1_0.l2 e0,0 .dg.1.c.sf0_0.e bw 382 l2,0 .dg.1.c.sf2_0.l2 e1,0 .dg.1.c.sf1_0.e bh 42 blockFont font17 e2,0 .dg.1.c.sf2_0.e type,0 3D n_subblock,0 1 subident,0,0 BEGIN_DATAGRID_3D ystart 397 radio 0 type,1 3D n_subblock,1 1 subident,1,0 BEGIN_DATAGRID_3D}
DataGridOK
array set isoControl {1,current_slide 1 isoline_color monocolor datagridDim 3 3,cpl_thermoFont {} 1,cpl_thermoNTics 6 3,time_delay 100 2,cpl_thermoNTics 6 3,cpl_thermoNTics 6 3,2Dnisoline 15 cpl_thermoNTics 6 3,anim_step 1 3,cpl_basis MONOCHROME 1,isoline_monocolor #000000 1,isoline_width 2 2,cpl_thermoFont {} 3,cpl_thermoFmt %%+8.4f 2,2Dlowvalue 0.000000 2,current_text_slide {Current slide:  1 / 31} 1,cpl_transparency 0 3,colorplane 0 blend_button .iso.fb1.f.right.f5.b3 3,isoline_color monocolor cbfn_apply_to_all 0 1,cpl_thermoFont {} 2,cpl_function LINEAR 1,time_delay 100 current_slide 1 revert_button1 .iso.fb1.f.right.f5.b12 1,2Dnisoline 15 revert_button2 .iso.fb1.f.right.f5.b10a 2Dlowvalue_entry .iso.fb2.f1.1.mf.r.f3.1.entry1 2,cpl_transparency 0 2Dnisoline_entry .iso.fb2.f1.1.mf.r.f5.1.entry1 2,isoline_monocolor #000000 1,2Dhighvalue 0.254230 cpl_basis MONOCHROME anim_step 1 1,isoline 0 2,isoline 0 3,2Dhighvalue 0.254230 3,isoline 0 2,cpl_thermoFmt %%+8.4f 2,colorplane_lighting 0 isoline_width 2 1,cpl_thermoLabel { Scale:   ? n(r)} 2,cpl_thermoLabel { Scale:   ? n(r)} isoline 0 3,cpl_thermoLabel { Scale:   ? n(r)} colorplane_lighting 0 cpl_thermoTplw 0 1,colorplane 0 cpl_thermoLabel { Scale:   ? n(r)} time_delay 100 3,cpl_transparency 0 2,isoline_color monocolor 2Dnisoline 15 3,current_slide 1 3,cpl_thermoTplw 0 max_allowed_2Dnisoline 100 3,2Dlowvalue 0.000000 cpl_function LINEAR anim_apply_to_all 0 1,anim_step 1 1,cpl_basis MONOCHROME 3,current_text_slide {Current slide:  1 / 61} 3,nslide 31 colorplane 0 cpl_transparency 0 3,isoline_monocolor #000000 3,isoline_width 2 1,cpl_function LINEAR 1,cpl_thermoFmt %%+8.4f 2Disolinewidth_entry .iso.fb2.f1.1.mf.i.3.f1.1.entry1 2,cpl_thermoTplw 0 2,time_delay 100 smooth_button .iso.fb1.f.right.f5.b2a 2,2Dnisoline 15 2,nslide 31 1,isoline_color monocolor disp_apply_to_all 0 plane {} 1,isoline_stipple {no stipple} 3Dinterpl_degree 1 2,isoline_stipple {no stipple} 2,current_slide 1 1,cpl_thermoTplw 0 3,isoline_stipple {no stipple} 1,2Dlowvalue 0.000000 isoline_stipple {no stipple} 2Dhighvalue_entry .iso.fb2.f1.1.mf.r.f4.1.entry1 1,current_text_slide {Current slide:  1 / 31} 1,nslide 31 2,colorplane 0 2,anim_step 1 2,cpl_basis MONOCHROME 1,cpl_thermometer 0 2,isoline_width 2 2,cpl_thermometer 0 3,cpl_thermometer 0 2,2Dhighvalue 0.254230 1,colorplane_lighting 0 bmc .iso.fb2.f1.1.mf.i.1.b color_button .iso.fb1.f.right.f5.b2 cpl_thermometer 0 isoline_monocolor #000000 isosurf 1 3,colorplane_lighting 0 3,cpl_function LINEAR 2Dhighvalue 0.254230 cpl_thermoFmt %%+8.4f cpl_thermoFont {} 2Dlowvalue 0.000000 current_text_slide {}}
array set prop {datagridDim 0 type_of_run RHF pm_isolevel 0 isolevel 0.00002}
array set isosurf {type_of_isosurf solid 3Dinterpl_degree 1 isovalue_entry .iso.fb1.f.left.f1.f3.1.entry1 1,2Dexpand_X 1 transparency off rangevalue 0.254230 1,2Dexpand_Y 1 1,2Dexpand none res_type angstroms 3,2Dexpand_X 1 1,2Dexpand_Z 1 twoside_lighting off 3,2Dexpand_Y 1 3,2Dexpand none 3,2Dexpand_Z 1 3Dinterpl_degree_old 1 space_sel whole_cell expand_X 1 tessellation_type cubes expand_Y 1 expand none expand_Z 1 minvalue 0.000000 mb_angs/bohr Angstroms old_twoside_lighting off spin {} 2,2Dexpand_X 1 maxvalue 0.254230 2,2Dexpand_Y 1 2,2Dexpand none Y_Sel centered 2,2Dexpand_Z 1 2Dexpand_X 1 normals_type gradient shade_model smooth Z_Sel centered 2Dexpand_Y 1 2Dexpand none 2Dexpand_Z 1}
UpdateIsosurf
