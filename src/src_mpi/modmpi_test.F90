!> Module for unit tests for for the functions in mod_mpi.
module modmpi_test
  ...
  character(len=*), parameter :: module_tested = "modmpi"
...
!DIR$ OPTIMIZE(-O0)
    ...
    integer(i32) :: n_groups, n_processes, rows_per_group, cols_per_group
