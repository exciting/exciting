module wfplot_module
  ...
  private
  public :: setup_wfplot_globals, setup_wfplot_k, calculate_wfplot, calculate_wfplot_k_chunk
  ...
  subroutine setup_wfplot_globals(xs_calculation)
  ...
  end subroutine setup_wfplot_globals
