...
!   [Phys. Rev. Lett. 77, 3865 (1996); 78, 1396(E) (1997)]. The parameter
!   $\kappa$, which controls the large-gradient limit, can be set to $0.804$
!   or $1.245$ corresponding to the value in the original article or the
