...
Subroutine emat_wannier( ik, vecql, ist1, nst1, ist2, nst2, emat)
      Use modmain
      Use modinput
      Implicit None
! arguments
      Integer, Intent (In) :: ik, ist1, nst1, ist2, nst2
...
! allocate local arrays
      ...
      Allocate( wfmt2( lmmaxvr, nrcmtmax, nst2))
...
! calculate the wavefunction for k-point k+q
              ...
              & evecfv2(:, ist), lmmaxvr, wfmt2( :, :, ist-ist2+1))
            End Do
...
! multiply wavefunction with exp(-iq.r)
               ...
               Do ist = ist2, ist2 + nst2 - 1
                ...
                ! & lmmaxvr, wfmt3, wfmt2( :, :, ist-ist2+1))
                 & lmmaxvr, wfmt1, wfmt2( :, :, ist-ist2+1))
               End Do
            End Do
