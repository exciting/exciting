...
nullify(np)  
np=>getAttributeNode(thisnode,"wfproj")
getstructlo%wfproj=.false.
if(associated(np)) then
       call extractDataAttribute(thisnode,"wfproj",getstructlo%wfproj)
       call removeAttribute(thisnode,"wfproj")  
endif
