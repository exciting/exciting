...
!                 write(fout,*)'rga: convw: calling bothpart1t with pars:'
!                 write(fout,*)'rga: convw: ee1 = ',ee1
!                 write(fout,*)'rga: convw: ee2 = ',ee2
!                 write(fout,*)'rga: convw: efer = ',efer
                 w1t(1:4)=0.0d0
                 call bpartoc(ee1,ee2,efer,w1t)
!                 write(fout,*)'rga: convw: bothpart1t returned:'
!                 write(fout,*)'rga: convw: w1t = ',w1t
                 do i=1,4
                   kin=tetcorn(i,itet)
