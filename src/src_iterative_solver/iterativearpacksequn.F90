...
integer:: nconv, maxitr, ishfts, mode
...
call znaupd(ido,bmat,n,which,nstfv,tol,resid,ncv,v,nmat(ik,ispn),\
   ...
   !call ZHPTRS('U', N, 1, AP, IPIV, B, LDB, INFO )
 ...
 !call zneupd  ( rvec, 'A', select, d, v, ldv, sigma, workev, bmat, n, which, nev, tol, resid, ncv, v, &
 !dv, iparam, ipntr, workd, workl, lworkl, rwork,&
 !ierr )
