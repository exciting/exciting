...
! local variables
real(8)::t1
call r3cross(input%structure%crystal%basevect(:, 2), input%structure%crystal%basevect(:, 3), bvec(:, 1))
call r3cross(input%structure%crystal%basevect(:, 3), input%structure%crystal%basevect(:, 1), bvec(:, 2))
call r3cross(input%structure%crystal%basevect(:, 1), input%structure%crystal%basevect(:, 2), bvec(:, 3))
t1 = input%structure%crystal%basevect(1, 1) * bvec(1, 1) + input%structure%crystal%basevect(2, 1) * bvec(2, 1) +&
