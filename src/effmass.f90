...
! copy eigenvalues to new array
  j1 = i1 + input%properties%masstensor%ndspem; j2 = i2 + input%properties%masstensor%ndspem; j3 = i3 +&
...
write(*, '(" for k-point (lattice) ", 3G18.10)') input%properties%masstensor%vklem
write(*, *)
