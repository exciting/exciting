...
module math_test_drivers
  ...
  use linear_algebra_2d_test, only: linear_algebra_2d_test_driver
  ...
  use ode_solver_test, only: radial_second_order_ode_test_driver
  ...
  subroutine math_test_driver(mpiglobal, kill_on_failure_)
    ...
    call linear_algebra_2d_test_driver(mpiglobal, kill_on_failure)
    ...
    call radial_second_order_ode_test_driver(mpiglobal, kill_on_failure)
