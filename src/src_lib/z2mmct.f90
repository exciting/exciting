...
! arguments
      ...
      c (1, 1) = a (1, 1) * conjg (b(1, 1)) + a (1, 2) * conjg (b(1, &
     & 2))
      c (1, 2) = a (1, 1) * conjg (b(2, 1)) + a (1, 2) * conjg (b(2, &
     & 2))
      c (2, 1) = a (2, 1) * conjg (b(1, 1)) + a (2, 2) * conjg (b(1, &
     & 2))
      c (2, 2) = a (2, 1) * conjg (b(2, 1)) + a (2, 2) * conjg (b(2, &
     & 2))
      Return
End Subroutine
!EOC
