...
module add_scaled_array
  ...
  interface scaled_add
    module procedure scaled_add_vectors_complex_dp
    module procedure scaled_add_matrices_complex_dp
  end interface

contains

  subroutine scaled_add_vectors_complex_dp(alpha, x, y)
  ...
  subroutine scaled_add_matrices_complex_dp(alpha, x, y)
    complex(dp), intent(in) :: alpha
    complex(dp), intent(in) :: x(:, :)
    complex(dp), intent(inout) :: y(:, :)
