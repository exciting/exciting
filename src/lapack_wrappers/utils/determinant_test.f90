...
module determinant_test
  ...
  subroutine test_determinant(test_report)
    ...
    A_2x2_complex = cmplx(transpose(reshape([  1.00_dp, -3.893_dp, &
                                             -23.032_dp, 5.893_dp], [2, 2])), &
                          transpose(reshape([ -2.321_dp, 12.123_dp, &
    ...
    A_complex = cmplx(transpose(reshape( &
            [ -44.52110712_dp, -48.17481048_dp,    -19.66887_dp,   2.95379091_dp, -32.48344889_dp, &
              ...
              -28.34722129_dp, -15.28477719_dp,  -9.98834923_dp,  19.58476894_dp, -45.2623859_dp , &
               25.18235434_dp,  45.25070169_dp,  39.07849915_dp,  15.93610182_dp, -33.5371513_dp ], [5, 5])), &
            transpose(reshape([  14.86243624_dp,  30.70582514_dp,   44.7784307_dp, -46.66873007_dp, -24.13516175_dp, &
