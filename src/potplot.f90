...
case(41)
  ...
  call plot1d(50, 51, 1, input%groundstate%lmaxvr, lmmaxvr, vclmt, vclir)
  close(50)
  close(51)
  open(50, file='VXC1D.OUT', action='WRITE', form='FORMATTED')
  open(51, file='VLINES.OUT', action='WRITE', form='FORMATTED')
  call plot1d(50, 51, 1, input%groundstate%lmaxvr, lmmaxvr, vxcmt, vxcir)
  close(50)
  close(51)
  write(*, *)
  write(*, '("Info(potplot):")')
...
case(42)
  ...
  call plot2d(50, 1, input%groundstate%lmaxvr, lmmaxvr, vclmt, vclir)
  close(50)
  open(50, file='VXC2D.OUT', action='WRITE', form='FORMATTED')
  call plot2d(50, 1, input%groundstate%lmaxvr, lmmaxvr, vxcmt, vxcir)
  close(50)
  write(*, *)
  write(*, '("Info(potplot):")')
...
case(43)
  ...
  call plot3d(50, 1, input%groundstate%lmaxvr, lmmaxvr, vclmt, vclir)
  close(50)
  open(50, file='VXC3D.OUT', action='WRITE', form='FORMATTED')
  call plot3d(50, 1, input%groundstate%lmaxvr, lmmaxvr, vxcmt, vxcir)
  close(50)
  write(*, *)
  write(*, '("Info(potplot):")')
