Subroutine DFT_D2_force
  ...
  force_disp=vdw_force_pairwiseC6(input%groundstate%DFTD2parameters%s6, input%groundstate%DFTD2parameters%rs6, input%groundstate%DFTD2parameters%d, input%groundstate%DFTD2parameters%cutoff, C6ab, R0ab)
