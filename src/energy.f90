...
module total_energy
  ...
  use mod_eigenvalue_occupancy, only: evalsv, nstfv, nstsv, occsv
  use mod_energy, only: e_disp, endipc, engybext, engybmt, engybxc, engycbc, &
    engyc, engycl, engyen, engyhalf, engyhar, &
    engykn, engykncr, engyknst, engymad, engynn, engytot, engyvcl, engyvxc, engyx, evalsum
  use mod_hybrids, only: exnl, vkl
  use mod_kpoint, only: wkpt, nkpt
  use mod_LDA_LU, only: engyalu, engylu, ldapu
  use mod_misc, only: task, tlast
