...
use modinput
  ...
  write(un, '(a, i8)') ' associated(input%xs%BSE) Hamiltonian size  :', bsehamsiz
  write(un, *)
  write(un, '(a)') 'Estimated memory consumption in GB (one q-point/&
       &total):'
  write(un, '(a, 2f12.3)') ' associated(input%xs%BSE) Hamiltonian	  :', m_bseham/gb
  write(un, '(a, 2f12.3)') ' associated(input%xs%BSE) eigenvectors	  :', m_bseeigvec/gb
  write(un, '(a, 2f12.3)') ' associated(input%xs%BSE) totals *		  :', (m_bseham+m_bseeigvec)/gb
  write(un, *)
  ...
  write(un, '(a, 2f12.3)') ' associated(input%xs%BSE)-kernel		       :', d_fxcbse/gb
