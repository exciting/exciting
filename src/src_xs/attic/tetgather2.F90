...
subroutine tetgather2
  ...
  implicit none
  ! local variables
  character(*), parameter :: thisnam='tetgather2'
  character(256) :: filnam,filnam_t
  integer :: iq,iproc,ik,ist1,ist2,nwdfp
        ...
        do ist1=1,nstsv
           do ist2=1,nstsv
              ...
              do iproc=0,procs-1
                 ...
                 call gettetcw2(iq,ik,ist1,ist2,nwdfp,trim(filnam_t),&
                      cwp,cwap,cwsurfp)
                 cw(wpari:wparf)=cwp(:)
              ...
              ! write weights
              call puttetcw2(iq,ik,ist1,ist2,trim(filnam),cw,cwa,cwsurf)
           end do ! ic
        end do ! iv
     end do ! ik
     do iproc=0,procs-1
