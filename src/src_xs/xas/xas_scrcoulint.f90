...
!	Application to direct terms between core states and conduction states for the
!	calculation of X-ray absorption spectroscopy. November 2015 by Christian Vorwerk

!EOP
!BOC      
      Implicit None
  ! local variables
      Character (*), Parameter :: thisnam = 'xas_scrcoulint'
...
!
     ! combine indices for matrix elements of plane wave
         ...
         Do ist4 = sta2, sto2
            Do ist3 = sta2, sto2
               j2 = j2 + 1
               emat34 (j2, :) = xiuu (ist3-sta2+1, ist4-sta2+1, :)
            End Do
         End Do
!
...
!
      Write (unitout, '("Info(xas_scrcoulint): Screened Coulomb interaction&
     & finished")')
!
End Subroutine xas_scrcoulint
!EOC
