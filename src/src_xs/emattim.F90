...
contains
  ...
  subroutine emattim(iq,ik,filnam,t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,&
    ...
    tmres=t9+t11+t13+t15
    tmares=t10+t12+t14+t16
    tm=tmres+tmares
    ...
    write(un,'("      APW-APW                             : ",f14.4)') t18
    write(un,'("      APW-lo                              : ",f14.4)') t19
    write(un,'("      lo -APW                             : ",f14.4)') t20
    write(un,'("      lo -lo                              : ",f14.4)') t21
    write(un,'("    interstitial contribution             : ",f14.4)') t8
    write(un,'("    matrix multiplications                : ",f14.4)') tm
    write(un,'("      resonant parts                      : ",f14.4)') tmres
    write(un,'("        APW-lo                            : ",f14.4)') t9
    write(un,'("        lo -APW                           : ",f14.4)') t11
    write(un,'("        lo -lo                            : ",f14.4)') t13
    write(un,'("        interstitial                      : ",f14.4)') t15
    write(un,'("      anti-resonant parts                 : ",f14.4)') tmares
    write(un,'("        APW-lo                            : ",f14.4)') t10
    write(un,'("        lo -APW                           : ",f14.4)') t12
    write(un,'("        lo -lo                            : ",f14.4)') t14
    write(un,'("        interstitial                      : ",f14.4)') t16
    write(un,'("    debugging                             : ",f14.4)') t17
