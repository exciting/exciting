...
!BOC
  ...
  ! check number of empty states
      ...
      if (.true.) then
         ...
         nst1 = input%xs%bse%nstlbsemat(2) - input%xs%bse%nstlbsemat(1) + 1
         nst2 = nst1
         nst3 = input%xs%bse%nstlbsemat(4) - input%xs%bse%nstlbsemat(3) + 1
         nst4 = nst3

         istl1 = input%xs%bse%nstlbsemat(1)
         istu1 = input%xs%bse%nstlbsemat(2)
         istl2 = input%xs%bse%nstlbsemat(1)
         istu2 = input%xs%bse%nstlbsemat(2)
         istl3 = input%xs%bse%nstlbsemat(3) + istocc0 - 1
         istu3 = input%xs%bse%nstlbsemat(4) + istocc0 - 1
         istl4 = istl3
         istu4 = istu3
