...
! double arrays
  ...
  !> Real 5 x 5 matrix
  real(dp), public :: real_matrix_5x5(5, 5) = reshape([-40.17392854_dp, -29.62435155_dp,  -0.82734985_dp, -10.30943673_dp, &
                                                        48.46185434_dp, &
                                                       ...
                                                       -25.42093406_dp,  23.68830969_dp, -23.00607822_dp,   12.7168522_dp, &
                                                        ...
                                                        33.70929988_dp], [5, 5])
  !> Real 5 x 7 matrix
  real(dp), public :: real_matrix_5x7(5, 7) = reshape([   9.06173884_dp, -16.40962765_dp,  15.66983533_dp,  29.14170303_dp, &
                                                        ...
                                                        -34.35152851_dp, -47.16065796_dp,   4.17329693_dp, &
                                                         ...
                                                         45.95078973_dp, -12.78879693_dp, -15.22917256_dp ], [5, 7])
  !> Real 7 x 5 matrix
  real(dp), public :: real_matrix_7x5(7, 5) = reshape([  -2.89185458_dp,  19.07126067_dp,  15.01048731_dp, -38.24203168_dp, &
  ...
  real(dp), public :: real_symmetric_matrix_5x5(5, 5) = reshape([[  47.3120746_dp,  26.77011639_dp,  28.32428222_dp,  27.30299212_dp, &
                                                                  -34.00535404_dp], &
...
! double complex arrays
  ...
  complex(dp), public :: complex_vector_7(7) = cmplx([ 25.62674667, -14.9142924 ,  -0.49922657, -20.83173308, &
                                                       21.61559333,  38.52653728,   6.02442546], &

                                                     [ 19.06604381,  10.34856432, -12.13899351,  16.90726442, &
                                                       16.16283436,   3.91299653,  -9.94204067], kind=dp)
  !> Complex 5 x 5 matrix
  complex(dp), public :: complex_matrix_5x5(5, 5) = reshape(cmplx([ -40.17392854_dp, -29.62435155_dp,  -0.82734985_dp, -10.30943673_dp, &
                                                                     48.46185434_dp, &
                                                                     47.31299703_dp,   6.77807354_dp,  11.67496062_dp, -35.14904297_dp, &
                                                                     14.48758125_dp, &
                                                                    -25.42093406_dp,  23.68830969_dp, -23.00607822_dp,   12.7168522_dp, &
  ...
  complex(dp), public :: complex_matrix_5x7(5, 7) = reshape(cmplx([ -18.7814739_dp, -35.75636149_dp, -25.89864277_dp,  11.04508789_dp, &
                                                                  ...
                                                                  [-28.97154895_dp, -30.01164974_dp,  37.37357186_dp,  15.58097948_dp, &
                                                                   ...
                                                                   -16.61908417_dp,  48.22907402_dp,  22.75478376_dp,  19.73577893_dp, &
                                                                    22.80786931_dp, -35.12437444_dp,  -1.31678731_dp], kind=dp), [5, 7])
  !> Complex 7 x 5 matrix
  complex(dp), public :: complex_matrix_7x5(7, 5) = reshape(cmplx([-15.76457636_dp, -13.10633076_dp,  24.50742622_dp,  27.78197405_dp, &
                                                                  ...
                                                                  [-29.56785948_dp,  -29.3596185_dp, -26.06947443_dp,  49.95145734_dp, &
                                                                   ...
                                                                   -34.18643191_dp], kind=dp), [7, 5])
  !> Complex hermitian 5 x 5 matrix
  complex(dp), public :: complex_hermitian_matrix_5x5(5, 5) = reshape(cmplx([-49.72690415_dp,  -14.84768354_dp,  10.05665554_dp,  29.36660616_dp, &
