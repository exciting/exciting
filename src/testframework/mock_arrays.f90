...
! double arrays
  ...
  real(dp), parameter, public :: real_vector_7(7) = [-26.54377445_dp, -17.22046184_dp,   4.83382119_dp,  -9.47731147_dp, &
                                            0.03664525_dp,   3.04736258_dp,  17.84092835_dp]
  !> Real 5 x 5 matrix
  real(dp), parameter, public :: real_matrix_5x5(5, 5) = transpose(reshape([-40.17392854_dp, -29.62435155_dp,  -0.82734985_dp, -10.30943673_dp, &
                                                                  48.46185434_dp, &
                                                                 ...
                                                                 -25.42093406_dp,  23.68830969_dp, -23.00607822_dp,   12.7168522_dp, &
                                                                  ...
                                                                  33.70929988_dp], [5, 5]))
  !> Real 5 x 7 matrix
  real(dp), parameter, public :: real_matrix_5x7(5, 7) = transpose(reshape([   9.06173884_dp, -16.40962765_dp,  15.66983533_dp,  29.14170303_dp, &
  ...
  !> Real 7 x 5 matrix
  real(dp), parameter, public :: real_matrix_7x5(7, 5) = transpose(reshape([  -2.89185458_dp,  19.07126067_dp,  15.01048731_dp, -38.24203168_dp, &
  ...
  real(dp), parameter, public :: real_symmetric_matrix_5x5(5, 5) = transpose(reshape([  47.3120746_dp,  26.77011639_dp,  28.32428222_dp,  27.30299212_dp, &
                                                                            -34.00535404_dp, &
  ...
  real(dp), parameter, public :: real_full_rank_matrix_5x5(5, 5) = transpose(reshape([  48.0900923_dp,  36.23203237_dp, -29.97433087_dp,   7.00464893_dp, &
                                                                            -1.57860058_dp, &
  ...
  real(dp), parameter, public :: real_rank_4_matrix_5x7(5, 7) = transpose(reshape([  9.06173884_dp, -16.40962765_dp,  15.66983533_dp,  29.14170303_dp, &
  ...
  real(dp), parameter, public :: real_rank_4_matrix_7x5(7, 5) = transpose(reshape([  9.06173884_dp, -16.40962765_dp,  15.66983533_dp,  29.14170303_dp, &
                                                                                 0.0_dp, &
                                                                        -16.41480408_dp, -13.45202387_dp, -35.18713482_dp, -44.0682099_dp , &
                                                                                 0.0_dp, &
                                                                         47.71787082_dp,  28.31043534_dp,  17.57815792_dp, -29.0436189_dp , &
...
! double complex arrays
  ...
  complex(dp), parameter, public :: complex_vector_5(5) = cmplx([ -2.30866203_dp, -30.44677196_dp,   36.2118037_dp, -30.5659898_dp, &
                                                       47.58889362_dp], &

                                                     [ 12.73245688_dp,  -43.5729583_dp,  27.03688433_dp,  49.7539840_dp, &
                                                      -41.57934484_dp], kind=dp)
  !> Complex vector with 7 elements
  complex(dp), parameter, public :: complex_vector_7(7) = cmplx([ 25.62674667_dp,  -14.9142924_dp,  -0.49922657_dp,-20.83173308_dp, &
  ...
  complex(dp), parameter, public :: complex_matrix_5x5(5, 5) = cmplx(transpose(reshape([ -40.17392854_dp, -29.62435155_dp,  -0.82734985_dp, -10.30943673_dp, &
                                                                               48.46185434_dp, &
                                                                               47.31299703_dp,   6.77807354_dp,  11.67496062_dp, -35.14904297_dp, &
                                                                               14.48758125_dp, &
                                                                              -25.42093406_dp,  23.68830969_dp, -23.00607822_dp,   12.7168522_dp, &
                                                                               ...
                                                                               16.33945082_dp,   39.7244291_dp,  -25.5748391_dp ,   39.604497_dp, &
                                                                               33.70929988_dp], [5, 5])), &
                                                            transpose(reshape([  -3.62805399_dp, 30.17124227_dp,  -3.54995097_dp, -23.27306593_dp, &
                                                                               32.75861251_dp, &
                                                                              ...
                                                                              -22.63124669_dp], [5, 5])), kind=dp)
  !> Complex 5 x 7 matrix
  complex(dp), parameter, public :: complex_matrix_5x7(5, 7) = cmplx(transpose(reshape([ -18.7814739_dp, -35.75636149_dp, -25.89864277_dp,  11.04508789_dp, &
                                                                             ...
                                                                             -17.20282601_dp, -19.55147567_dp,  18.65011868_dp,  22.76807154_dp, &
                                                                               41.5186408_dp,   -6.0275415_dp,  43.86113634_dp], [7, 5])), &
                                                             transpose(reshape([-28.97154895_dp, -30.01164974_dp,  37.37357186_dp,  15.58097948_dp, &
                                                                             ...
                                                                             -16.61908417_dp,  48.22907402_dp,  22.75478376_dp,  19.73577893_dp, &
                                                                              22.80786931_dp, -35.12437444_dp,  -1.31678731_dp], [7, 5])), kind=dp)
  !> Complex 7 x 5 matrix
  complex(dp), parameter, public :: complex_matrix_7x5(7, 5) = cmplx(transpose(reshape([-15.76457636_dp, -13.10633076_dp,  24.50742622_dp,  27.78197405_dp, &
                                                                             ...
                                                                             -12.69575022_dp,  14.96294671_dp, -33.74281834_dp, -36.73461298_dp, &
                                                                               4.77888767_dp], [5, 7])), &
                                                          transpose(reshape([-29.56785948_dp,  -29.3596185_dp, -26.06947443_dp,  49.95145734_dp, &
                                                                             ...
                                                                             -34.18643191_dp], [5, 7])), kind=dp)
  !> Complex hermitian 5 x 5 matrix
  complex(dp), parameter, public :: complex_hermitian_matrix_5x5(5, 5) = cmplx(transpose(reshape([-49.72690415_dp,  -14.84768354_dp,  10.05665554_dp,  29.36660616_dp, &
                                                                                        ...
                                                                                        -20.0201864_dp , -16.29220719_dp,  13.16564869_dp,  21.26837488_dp, &
                                                                                         42.3303856_dp ], [5, 5])), &
                                                                    transpose(reshape([         0.0_dp,   5.21297468_dp,  -0.68828716_dp,  -18.61860468_dp, &
  ...
  complex(dp), parameter, public :: complex_positive_definite_matrix_5x5(5, 5) = &
        cmplx(transpose(reshape( [ 53.6764_dp,  54.7824_dp,  47.3528_dp,  31.1708_dp,  20.0872_dp,  &
                                    ...
                                    20.0872_dp,  25.2152_dp,  54.3952_dp,  96.2032_dp, 168.1132_dp], [5,5])),  &
              transpose(reshape( [   0.000_dp,   -0.700_dp,  -16.548_dp,  -45.024_dp,  -81.032_dp,  &
                                     ...
                                     81.032_dp,   82.222_dp,   61.180_dp,   23.786_dp,    0.000_dp], [5, 5])), kind=dp)
  !> Complex unitary 5 x 5 matrix
  complex(dp), parameter, public :: complex_unitary_matrix_5x5(5, 5) = cmplx(transpose(reshape([-0.33365437_dp, -0.21756134_dp,  0.07501474_dp, -0.28585794_dp,  0.10201445_dp, &
                                                                                     ...
                                                                                     -0.22716718_dp,  0.14406867_dp,  0.25321109_dp, -0.29045102_dp,  0.49170423_dp, &
                                                                                      ...
                                                                                      [5, 5])), &
                                                                      transpose(reshape([  0.47787822_dp, -0.17924166_dp, -0.18438518_dp, -0.66834485_dp,  0.04914282_dp, &
                                                                                      ...
                                                                                      -0.35775856_dp, -0.61785542_dp,  0.24480553_dp, -0.2492159_dp , -0.14065227_dp], [5, 5])), kind=dp)
  !> Complex full rank 5 x 5 matrix
  complex(dp), parameter, public :: complex_full_rank_matrix_5x5(5, 5) = cmplx(transpose(reshape([-44.52110712_dp, -48.17481048_dp,    -19.66887_dp,   2.95379091_dp, &
                                                                                       -32.48344889_dp, &
                                                                                       ...
                                                                                       -28.34722129_dp, -15.28477719_dp,  -9.98834923_dp,  19.58476894_dp, &
                                                                                        ...
                                                                                        -33.5371513_dp ], [5, 5])), &
                                                                    transpose(reshape([ 14.86243624_dp,  30.70582514_dp,  44.7784307_dp, -46.66873007_dp, &
                                                                                       -24.13516175_dp, &
                                                                                       ...
                                                                                       -27.88252968_dp], [5, 5])), kind=dp)

  !> Real 5 x 7 matrix with rank 4
  complex(dp), parameter, public :: complex_rank_4_matrix_5x7(5, 7) = cmplx(transpose(reshape([ -18.7814739_dp, -35.75636149_dp, -25.89864277_dp,  11.04508789_dp, &
                                                                                             0.0_dp,          0.0_dp,          0.0_dp, &
                                                                                     33.75023754_dp,  49.97417692_dp,  -0.48275953_dp,  43.98236553_dp, &
                                                                                             0.0_dp,          0.0_dp,          0.0_dp, &
                                                                                     21.48351648_dp,   1.63997878_dp,  16.31513844_dp,  29.47589814_dp, &
                                                                    ...
                                                                    transpose(reshape([-28.97154895_dp, -30.01164974_dp,  37.37357186_dp,  15.58097948_dp, &
                                                                                    ...
                                                                                    -43.59929192_dp,  34.88338453_dp,  -4.6433614_dp,   9.07841908_dp, &
                                                                                             0.0_dp,          0.0_dp,          0.0_dp, &
                                                                                             0.0_dp,          0.0_dp,          0.0_dp,          0.0_dp, &
                                                                                             0.0_dp,          0.0_dp,          0.0_dp], [7, 5])), kind=dp)

  !> Real 7 x 5 matrix with rank 4
  complex(dp), parameter, public :: complex_rank_4_matrix_7x5(7, 5) = cmplx(transpose(reshape([ -18.7814739_dp, -35.75636149_dp, -25.89864277_dp,  11.04508789_dp, &
                                                                                             0.0_dp, &
                                                                                     33.75023754_dp,  49.97417692_dp,  -0.48275953_dp,  43.98236553_dp, &
                                                                                             0.0_dp, &
                                                                                     21.48351648_dp,   1.63997878_dp,  16.31513844_dp,  29.47589814_dp, &
