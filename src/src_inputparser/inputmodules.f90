...
nullify(np)  
np=>getAttributeNode(thisnode,"banmin")
getstructnlo%banmin=1
if(associated(np)) then
       call extractDataAttribute(thisnode,"banmin",getstructnlo%banmin)
       call removeAttribute(thisnode,"banmin")  
endif

nullify(np)  
np=>getAttributeNode(thisnode,"banmax")
getstructnlo%banmax=0
if(associated(np)) then
       call extractDataAttribute(thisnode,"banmax",getstructnlo%banmax)
       call removeAttribute(thisnode,"banmax")  
endif

nullify(np)  
np=>getAttributeNode(thisnode,"delta")
getstructnlo%delta=0.004d0
if(associated(np)) then
       call extractDataAttribute(thisnode,"delta",getstructnlo%delta)
       call removeAttribute(thisnode,"delta")  
endif

nullify(np)  
np=>getAttributeNode(thisnode,"dw")
getstructnlo%dw=0.001d0
if(associated(np)) then
       call extractDataAttribute(thisnode,"dw",getstructnlo%dw)
       call removeAttribute(thisnode,"dw")  
endif

nullify(np)  
np=>getAttributeNode(thisnode,"emesh")
getstructnlo%emesh=400
if(associated(np)) then
...
nullify(np)  
np=>getAttributeNode(thisnode,"sc")
getstructnlo%sc=0.049d0
if(associated(np)) then
       call extractDataAttribute(thisnode,"sc",getstructnlo%sc)
       call removeAttribute(thisnode,"sc")  
endif

nullify(np)  
np=>getAttributeNode(thisnode,"tol")
getstructnlo%tol=0.001d0
if(associated(np)) then
       call extractDataAttribute(thisnode,"tol",getstructnlo%tol)
       call removeAttribute(thisnode,"tol")  
endif
