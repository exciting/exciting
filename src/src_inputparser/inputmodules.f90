...
nullify(np)  
np=>getAttributeNode(thisnode,"lock")
getstructatom%lock=(/.false.,.false.,.false./)
if(associated(np)) then
       call extractDataAttribute(thisnode,"lock",getstructatom%lock)
       call removeAttribute(thisnode,"lock")  
endif
...
getstructstructureoptimization%method= "simple"
if(associated(np)) then
       call extractDataAttribute(thisnode,"method",getstructstructureoptimization%method)
...
getstructstructureoptimization%history=.false.
if(associated(np)) then
...
enddo
            ...
            len= countChildEmentsWithName(thisnode,"nlo")
getstructproperties%nlo=>null()
Do i=0,len-1
getstructproperties%nlo=>getstructnlo(&
removeChild(thisnode,item(getElementsByTagname(thisnode,&
"nlo"),0)) ) 
enddo
...
function getstructnlo(thisnode)
! Do not edit! This file is automatically generated from the XML Schema
implicit none
type(Node),pointer::thisnode
type(nlo_type),pointer::getstructnlo
type(Node),pointer::np


integer::len=1,i=0
allocate(getstructnlo)  
#ifdef INPUTDEBUG      
      write(*,*)"we are at nlo"
#endif
...
nullify(np)  
np=>getAttributeNode(thisnode,"wmax")
getstructnlo%wmax=0.3
if(associated(np)) then
       call extractDataAttribute(thisnode,"wmax",getstructnlo%wmax)
       call removeAttribute(thisnode,"wmax")  
endif

nullify(np)  
np=>getAttributeNode(thisnode,"wgrid")
getstructnlo%wgrid=400
if(associated(np)) then
       call extractDataAttribute(thisnode,"wgrid",getstructnlo%wgrid)
       call removeAttribute(thisnode,"wgrid")  
endif

nullify(np)  
np=>getAttributeNode(thisnode,"swidth")
getstructnlo%swidth=0.01d0
if(associated(np)) then
       call extractDataAttribute(thisnode,"swidth",getstructnlo%swidth)
       call removeAttribute(thisnode,"swidth")  
endif

nullify(np)  
np=>getAttributeNode(thisnode,"scissor")
getstructnlo%scissor=0.0d0
if(associated(np)) then
       call extractDataAttribute(thisnode,"scissor",getstructnlo%scissor)
       call removeAttribute(thisnode,"scissor")  
endif

nullify(np)  
np=>getAttributeNode(thisnode,"etol")
getstructnlo%etol=0.004d0
if(associated(np)) then
...
allocate(getstructnlo%chicomp(3,len))
Do i=1,len

getstructnlo%chicomp(:,i)=getvalueofchicomp(&
      removechild(thisnode,item(getElementsByTagname(thisnode,&
      "chicomp"),0)))
end do
