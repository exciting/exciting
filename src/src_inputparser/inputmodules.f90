...
getstructnlo%emax=0.5
if(associated(np)) then
       call extractDataAttribute(thisnode,"emax",getstructnlo%emax)
       call removeAttribute(thisnode,"emax")  
endif

nullify(np)  
np=>getAttributeNode(thisnode,"emesh")
getstructnlo%emesh=100
if(associated(np)) then
       call extractDataAttribute(thisnode,"emesh",getstructnlo%emesh)
       call removeAttribute(thisnode,"emesh")  
endif
...
nullify(np)  
np=>getAttributeNode(thisnode,"chicomp")
getstructnlo%chicomp=(/1,2,3/)
if(associated(np)) then
       call extractDataAttribute(thisnode,"chicomp",getstructnlo%chicomp)
       call removeAttribute(thisnode,"chicomp")  
endif
