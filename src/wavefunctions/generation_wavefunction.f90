...
contains
  ...
  !> The total number of second variation basis functions (num_of_basis_functions_sv) is the 
  ...
  !> The total number of second variation basis function (num_of_basis_functions_sv) is equal to the
  ...
  subroutine generate_basisfunction_secondvariation_MT(lmax, lmmax,&
    ...
    complex(dp), intent(out) :: wfmtfv(lmmax, nrcmtmax, get_num_of_basis_functions_sv())
