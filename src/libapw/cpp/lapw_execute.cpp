                                      ...
                                      double *occsv_, double *densmt_, double *densir_, int32_t *flags_)
{
    ...
    if (flags & 2)
    {
        mdarray<double,6> densmt(densmt_, lapw_global.nrfmtmax, lapw_global.nrfmtmax, lapw_global.lmmaxvr, lapw_global.natmtot, lapw_global.nspinor, lapw_global.nspinor); 
