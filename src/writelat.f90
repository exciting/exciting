...
write(50, '("+----------------------------+")')
write(50, *)
write(50, '("vector a1 : ", 3G18.10)') input%structure%crystal%basevect(:, 1)
write(50, '("vector a2 : ", 3G18.10)') input%structure%crystal%basevect(:, 2)
write(50, '("vector a3 : ", 3G18.10)') input%structure%crystal%basevect(:, 3)
write(50, *)
