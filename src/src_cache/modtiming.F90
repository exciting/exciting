...
program test_timing
  ...
  call new_timer2(mytimer,'combined')
  
  call report_timer2(mytimer,un)

  call tic_timer2(mytimer)
  call report_timer2(mytimer,un)
  call sleep(1)
...
a=matmul(a,a)
  ...
  write(*,*) 'is_systemclock:',is_systemclock_timer2(mytimer)
  write(*,*) 'is_cpuclock:',is_cpuclock_timer2(mytimer)
  write(*,*) 'getintmean:',get_intmean_timer2(mytimer)
  write(*,*) 'getintmean_system:',get_intmean_system_timer2(mytimer)
  t0=get_intmean_cpu_timer2(mytimer)
  write(*,*) 'getintmean_cpu:',t0
