...
subroutine wannier_interpolate_density( int_kset)
  ...
  real(8) :: efermiint, wgt, rc(3), s(3,3), v1(3)
  complex(8) :: z1
...
!$OMP END PARALLEL
  ...
  deallocate( w, apwalm, wfmttp, wfmtlm, rmttp, zfft)
  !stop
  ...
  !do ir = 1, wf_Gset%ngrtot
  !  write( *, '(I6.6,3x,SP,3F23.6)') ir, rhoir( ir), rhoir_int( ir), rhoir_int( ir)/rhoir( ir) - 1.d0
  !end do
